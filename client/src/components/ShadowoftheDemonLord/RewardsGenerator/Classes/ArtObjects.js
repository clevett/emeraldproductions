...
class ArtObjects extends Valuable {
  ...
  determineArtObject = (value) => {
    ...
    switch(value) {
      ...
      case (100):
        return ['jeweled gold crown', 'jeweled gold signet ring', 'small gold statuette set with rubies', 'gold goblet set with emeralds', 'silver jewelry box with gold inlay', 'painted ring box set with diamonds', 'jade game board with solid silver playing pieces', 'bejeweled ivory drinking horn with gold filigree']
      default:
        return []
    }
  }

import Coins from "../../../../ShadowoftheDemonLord/RewardsGenerator/Classes/Coins"

const coinList = (total:number) => {
  ...
  const remainingCoins = remainder ? treasure.convertToCoins(remainder) : {silver: 0, copper: 0}
